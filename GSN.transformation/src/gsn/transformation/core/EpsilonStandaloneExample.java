...
public abstract class EpsilonStandaloneExample {
  ...
  protected EmfModel createEmfModel(String name, String model, 
    ...
    properties.put(EmfModel.PROPERTY_FILE_BASED_METAMODEL_URI, 
        "file:/" + getFile2(metamodel).getAbsolutePath());
    properties.put(EmfModel.PROPERTY_MODEL_URI, 
        "file:/" + getFile2(model).getAbsolutePath());
  ...
  protected EmfModel createEmfModelByURI(String name, String model, 
	...
	protected File getFile1(String fileName) throws URISyntaxException {
	...
	protected File getFile2(String fileName) throws URISyntaxException {
